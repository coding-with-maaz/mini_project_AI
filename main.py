...
def main():
    def initial_options():
        ...
        if st.session_state.user_menu == 'Recommend me a similar movie':
            ...
            if st.session_state.selected_movie_name:
                ...
                st.write("Please select a movie from the 'Recommend me a similar movie' section first to view its details.")
    ...
    def display_movie_details():
        ...
        try:
            ...
            st.error(f"Error: {e}")
            st.write("Please select a valid movie from the recommendation section.")
            return
